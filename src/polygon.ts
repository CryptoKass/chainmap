...
export default {
  ...
  zkevm: asProxyArray<typeof zkevmRPCs, string>(zkevmRPCs),
  mumbai: asProxyArray<typeof mumbaiRPCs, string>(mumbaiRPCs),
  zkevmtest: asProxyArray<typeof zkevmtestRPCs, string>(zkevmtestRPCs),
}
